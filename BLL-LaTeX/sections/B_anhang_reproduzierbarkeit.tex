...
\begin{itemize}
  ...
  \item USB-NFC/RFID-Lesegeraet (kompatibel mit libnfc)
...
\begin{itemize}
  ...
  \item \textbf{Erwartete Ausgabe:} Ein erfolgreicher NFC-Scan liefert ein JSON-Objekt mit \texttt{"valid": true} und der \texttt{photoUrl} des Schuelers zurueck.
\end{itemize}
