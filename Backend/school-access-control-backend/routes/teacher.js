...
module.exports = (db) => {
  ...
  // Assign a card to a student (any teacher can do this or admin can bypass)
  ...
  // Invalidate a card (only tutors can do this or admin can bypass)
  ...
  // View permissions (any teacher can do this or admin can bypass)
